...
public class PrintList {
    ...
    static {
        ...
        COMMANDS.add(5, "6. type \"rm -d department_id\" to remove department");
        ...
        COMMANDS.add(7, "8. type \"save -e -n employee_name -ln employee_lastname " +
                "-t type(m for manager or d for developer) -a age -dp department_id " +
        ...
        COMMANDS.add(12, "13. type \"search -e  -a age_to_search -d department_id\" for view all employees by age and department name");
